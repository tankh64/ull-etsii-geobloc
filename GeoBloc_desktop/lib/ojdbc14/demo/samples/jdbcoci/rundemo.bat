...
set CLASSPATH=%DEMO_CLASSPATH%;%ORACLE_HOME%\jdbc\lib\ojdbc14.jar;%ORACLE_HOME%\jdbc\lib\orai18n.jar;%ORACLE_HOME%\jlib\providerutil.jar;%ORACLE_HOME%\jlib\fscontext.jar
