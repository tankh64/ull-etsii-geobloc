 ...
 * in JDBC 3.0.  You should use JDK 1.4 and the ojdbc14.jar file
 * that is shipped with Oracle JDBC to compile and execute this
 * program.  The program uses the HR schema in the Oracle seed
