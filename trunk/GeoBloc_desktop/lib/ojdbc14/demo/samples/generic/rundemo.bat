...
set CLASSPATH14=.;%ORACLE_HOME%\jdbc\lib\ojdbc14.jar;%DEMO_CLASSPATH%;%ORACLE_HOME%\jlib\providerutil.jar;%ORACLE_HOME%\jlib\fscontext.jar;%ORACLE_HOME%\jlib\orai18n.jar
set CLASSPATH14g=.;%ORACLE_HOME%\jdbc\lib\ojdbc14_g.jar;%DEMO_CLASSPATH%;%ORACLE_HOME%\jlib\providerutil.jar;%ORACLE_HOME%\jlib\fscontext.jar;%ORACLE_HOME%\jlib\orai18n.jar
...
REM :RowSet01
REM %JAVAC% -classpath %CLASSPATH14% -g  RowSet01.java
REM sqlplus hr/hr <  rowset.sql
REM %JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% RowSet01
REM if "%1" == "RowSet01" goto end

REM :RowSet02
REM %JAVAC% -classpath %CLASSPATH14% -g  RowSet02.java
REM %JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% RowSet02
REM if "%1" == "RowSet02" goto end

REM :RowSet03
REM %JAVAC% -classpath %CLASSPATH14% -g  RowSet03.java
REM %JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% RowSet03
REM if "%1" == "RowSet03" goto end

REM :RowSet04
REM %JAVAC% -classpath %CLASSPATH14% -g  RowSet04.java
REM %JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% RowSet04
REM if "%1" == "RowSet04" goto end

REM :WebRowset01
REM %JAVAC% -classpath %CLASSPATH14% -g WebRowset01
REM %JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% WebRowset01
...
:ORADataExample
%JAVAC% -classpath %CLASSPATH14% -g  ORADataExample.java
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% ORADataExample
if "%1" == "ORADataExample" goto end

:FileExample
%JAVAC% -classpath %CLASSPATH14% -g  FileExample.java
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% FileExample %JDBC_TEMPDIR%
if "%1" == "FileExample" goto end

:LobExample
%JAVAC% -classpath %CLASSPATH14% -g  LobExample.java
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% LobExample
if "%1" == "LobExample" goto end

:OpenCloseLob
%JAVAC% -classpath %CLASSPATH14% -g  OpenCloseLob.java
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% OpenCloseLob
if "%1" == "LobExample" goto end

:PLSQL_FileExample
%JAVAC% -classpath %CLASSPATH14% -g  PLSQL_FileExample.java
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% PLSQL_FileExample %JDBC_TEMPDIR%
if "%1" == "PLSQL_FileExample" goto end

:PLSQL_LobExample
%JAVAC% -classpath %CLASSPATH14% -g  PLSQL_LobExample.java
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% PLSQL_LobExample
if "%1" == "PLSQL_LobExample" goto end

:PersonObject
%JAVAC% -classpath %CLASSPATH14% -g  PersonObject.java
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% PersonObject
if "%1" == "PersonObject" goto end

:PersonRef
%JAVAC% -classpath %CLASSPATH14% -g  PersonRef.java
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% PersonRef
if "%1" == "PersonRef" goto end

:RefClient
%JAVAC% -classpath %CLASSPATH14% -g  RefClient.java
...
:ImplicitCache01_opt
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL%  ImplicitCache01
if "%1" == "ImplicitCache01" goto end

:ImplicitCache02
%JAVAC% -classpath %CLASSPATH14% -g ImplicitCache02.java
...
"ImplicitCache02_opt
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% ImplicitCache02
if "%1" == "ImplicitCache02" goto end

:ImplicitCache03
%JAVAC% -classpath %CLASSPATH14% -g ImplicitCache03.java
...
:ImplicitCache03_opt
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% ImplicitCache03
if "%1" == "ImplicitCache03" goto end

:ImplicitCache04
%JAVAC% -classpath %CLASSPATH14% -g ImplicitCache04.java
...
:ImplicitCache04_opt
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% ImplicitCache04
if "%1" == "ImplicitCache04" goto end

:ImplicitCache05
%JAVAC% -classpath %CLASSPATH14% -g ImplicitCache05.java
...
:ImplicitCache05_opt
%JAVA% -classpath %CLASSPATH14% -DJDBC_URL=%JDBC_URL% ImplicitCache05
if "%1" == "ImplicitCache05" goto end

:ProxySession01
%JAVAC% -classpath %CLASSPATH14% -g ProxySession01.java
sqlplus hr/hr < ProxySession01.sql
%JAVA% -classpath %CLASSPATH14% ProxySession01
...
REM%JAVAC% -classpath %CLASSPATH14% -g FastConnectionFailover01.java
...
REM%JAVA% -classpath %CLASSPATH14g% \
...
REM%JAVA% -classpath %CLASSPATH14% \
REM -DJDBC_URL=%JDBC_URL% \
REM -Doracle.ons.oraclehome=$(ONS_HOME) FastConnectionFailover01
REMif "%1" == "FastConnectionFailover01" goto end
 
REM:FastConnectionFailover02
REM%JAVAC% -classpath %CLASSPATH14% -g FastConnectionFailover02.java
...
REM%JAVAC% -classpath %CLASSPATH14% -g FastConnectionFailover03.java
