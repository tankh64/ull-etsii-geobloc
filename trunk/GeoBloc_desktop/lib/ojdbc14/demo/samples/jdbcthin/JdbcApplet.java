 ...
 *
 * One way to get this work using appletviewer or netscape
 *  (with jdk1.2.2_07 or later version plugins):
 * 1. compile this file using jdk1.2.2_07 or later jdk version, use classes12.jar
 *    or ojdbc14.jar. 
 * 2. put classes12.jar or ojdbc14.jar at the same directory as the codebase 
 *    indicated in JdbcApplet.htm file
 * 3. modify JdbcApplet.htm file to let codebase point to the directory
 *    where JdbcApplet.class and classes12.jar or ojdbc14.jar exist.
